...
/////////////////////////////////////////////////////////////////////////////
///
/// @class cModernMenuProvider
///
/// @brief
/// Provides menu labels with Modern/CUA keyboard shortcuts.
/// Implements IMenuProvider for Modern input mode.
/// Uses standard CUA shortcuts (Ctrl+S, Ctrl+O, Ctrl+C/V/X/Z) for
/// common operations and Alt+K/Q/O/P prefix chords for advanced
/// WordStar operations.
///
/////////////////////////////////////////////////////////////////////////////
class cModernMenuProvider : public IMenuProvider
{
public:
    cModernMenuProvider(void) = default;
    ~cModernMenuProvider(void) override = default;
