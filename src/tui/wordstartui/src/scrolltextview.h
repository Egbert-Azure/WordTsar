...
#ifndef WORDTSAR_TUI_SCROLLTEXTVIEW_H
#define WORDTSAR_TUI_SCROLLTEXTVIEW_H
...
class cScrollTextView final : public cWidget
{
    // =================================================================
    // METHODS
    // =================================================================
...
public:
    cScrollTextView(const sRect& bounds);
